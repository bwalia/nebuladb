...
|---|---|---|
| 1 | `nebula-resource` crate, mode state machine, disk-critical write gate, metrics + `/admin/reliability` | **this PR** |
| 2 | AI decoupling: embed retries, circuit breaker, durable embedding queue, embedding versioning | next |
